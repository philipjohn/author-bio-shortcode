...
The output now contains HTML, which can be customised very easily with extra parameters - see Usage for a how-to - to sit around the bio, as defined in /wp-admin/profile.php.
...
= 1.2.1 =
* Tidied up PHP Notices (kudos to <a href="http://www.leewillis.co.uk/">Lee Willis</a> for pointing that out!)
